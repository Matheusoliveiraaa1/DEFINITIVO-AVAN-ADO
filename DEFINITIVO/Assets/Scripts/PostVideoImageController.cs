...

{
    ...
    [Header("Audio Prefabs (Exclusivo)")]
...

    {
        ...
        // 🔊 TOCAR ÁUDIO DA ÁREA
        if (prefabAudioSource != null && audioByArea.ContainsKey(areaName))
        {
    ...
    {
        if (clip == null || prefabAudioSource == null)
            yield break;
        ...
        while (prefabAudioSource.isPlaying)
            yield return null;
    }
